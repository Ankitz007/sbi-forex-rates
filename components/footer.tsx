        ...
        <Alert className="border-dashed">
          ...
          <AlertDescription className="text-sm leading-relaxed">
            ...
            <span className="text-muted-foreground">
              ...
              website is collated from SBI accurately, it is provided on an
              &quot;as is&quot; basis, without any warranties as to fitness for
              any particular purpose, or with respect to the results which may
              be obtained from the use of such information and without any
